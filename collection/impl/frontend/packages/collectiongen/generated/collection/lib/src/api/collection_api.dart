...
class CollectionApi {
  ...
  Future<Response<Collection>> init({ 
    ...
    final _queryParameters = <String, dynamic>{
      r'bucket': encodeQueryParameter(_serializers, bucket, const FullType(String)),
      r'prefix': encodeQueryParameter(_serializers, prefix, const FullType(String)),
    };
  ...
  Future<Response<Collection>> insert({ 
    ...
    final _path = r'/Collection/insert';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
  ...
  Future<Response<bool>> member({ 
    ...
    final _path = r'/Collection/member';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        if (contentType != null) r'Content-Type': contentType,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> optionsInit({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> optionsInsert({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> optionsMember({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> optionsRemove({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/Collection/remove';
    final _options = Options(
      method: r'OPTIONS',
      headers: <String, dynamic>{
        ...?headers,
