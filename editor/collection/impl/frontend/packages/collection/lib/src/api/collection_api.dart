...
class CollectionApi {
  ...
  Future<Response<String>> callSet({ 
    ...
    try {
      const _type = FullType(Collection);
      _bodyData = collection == null ? null : _serializers.serialize(collection, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> optionsGetCollection({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> optionsSetCollection({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
